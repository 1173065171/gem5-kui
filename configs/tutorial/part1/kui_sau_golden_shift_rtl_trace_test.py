#!/usr/bin/env python3
"""
KuiSau shift-mode GEMM test with RTL-style C-read gating.

GEMM work_mode=0 does not use C/bias, so enabling rtl_c_read_gate should leave
the functional output and zero-C request summary unchanged.
"""
...
print("=" * 80)
print("KuiSau Golden Shift-Mode GEMM RTL-Trace Test")
print("=" * 80)
