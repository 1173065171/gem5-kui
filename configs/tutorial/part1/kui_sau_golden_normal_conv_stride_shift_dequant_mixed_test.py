#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution stride+shift+dequant golden test.

This config runs conv_kernel=2 with register_mode=0, stride=1, shift_mode=1,
work_mode=2, and cutbit=2. SauGoldenGen checks stride row selection, int16
output packing, C scaling, and mixed-sign dequantization together.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="normal_conv_stride_shift_dequant_mixed",
)
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Stride+Shift+Dequant Test")
print("=" * 80)
