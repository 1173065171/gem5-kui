#!/usr/bin/env python3
"""
KuiSau deterministic output-transpose golden-reference test.

This config runs GEMM with flow_mode=1. SauGoldenGen lays out A as an identity
matrix and checks that output transpose turns the fixed B row pattern into D
rows filled with 15, 14, ..., 0 after SAU.py-style output packing.
"""
...
print("=" * 80)
print("KuiSau Golden Output-Transpose Test")
print("=" * 80)
