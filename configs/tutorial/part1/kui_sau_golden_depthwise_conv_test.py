#!/usr/bin/env python3
"""
KuiSau deterministic depthwise-convolution golden-reference test.

This config runs conv_kernel=2 with register_mode=2. SauGoldenGen uses the
same one-hot A lane as the normal-conv case and checks the DW B-mask output.
"""
...
print("=" * 80)
print("KuiSau Golden Depthwise-Conv Test")
print("=" * 80)
