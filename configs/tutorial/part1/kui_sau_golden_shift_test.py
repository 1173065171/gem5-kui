#!/usr/bin/env python3
"""
KuiSau deterministic shift-mode GEMM golden-reference test.

This config runs GEMM with shift_mode=1. SauGoldenGen lays out A so SAU.py's
int16 preprocessing sees an identity matrix, then checks the 512-byte int16 D
output packing.
"""
...
print("=" * 80)
print("KuiSau Golden Shift-Mode GEMM Test")
print("=" * 80)
