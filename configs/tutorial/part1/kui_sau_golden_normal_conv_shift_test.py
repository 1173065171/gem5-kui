#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution shift-mode golden-reference test.

This config runs conv_kernel=2 with register_mode=0 and shift_mode=1.
SauGoldenGen writes one nonzero A lane and checks the SAU.py-derived 512-byte
int16 D output packing after the normal-conv shift staging path.
"""
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Shift Test")
print("=" * 80)
