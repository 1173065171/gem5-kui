#!/usr/bin/env python3
"""
KuiSau pointwise-convolution test with RTL-style C-read gating.

Pointwise uses work_mode=1, so RTL mem_addr.sv still issues the two C/bias
reads. This checks that enabling rtl_c_read_gate preserves both the SAU.py
functional output and the expected C request summary for the bias path.
"""
...
print("=" * 80)
print("KuiSau Golden Pointwise Conv RTL-Trace Test")
print("=" * 80)
