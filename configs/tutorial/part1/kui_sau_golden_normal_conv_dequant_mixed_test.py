#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution dequantization golden-reference test.

This config runs normal convolution with work_mode=2 and cutbit=2. SauGoldenGen
uses a one-hot A tile, alternating signed B columns, and all-one C bias to check
normal-conv staging combined with C scaling and signed int8 dequantization.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="normal_conv_dequant_mixed",
)
...
print("=" * 80)
print("KuiSau Golden Normal Conv Mixed Dequant Test")
print("=" * 80)
