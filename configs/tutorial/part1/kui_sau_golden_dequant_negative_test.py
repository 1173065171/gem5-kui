#!/usr/bin/env python3
"""
KuiSau deterministic negative dequantization golden-reference test.

This config runs GEMM with cutbit=2. SauGoldenGen uses all-one A rows and a
negative B pattern so the output checks arithmetic right shift and int8
negative saturation before byte packing.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="gemm_dequant_negative",
)
...
print("=" * 80)
print("KuiSau Golden Negative Dequant Test")
print("=" * 80)
