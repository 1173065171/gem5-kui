#!/usr/bin/env python3
"""
KuiSau deterministic matrix-add golden-reference test.

This config runs work_mode=3 with A all zero and B as a fixed byte pattern.
After SAU.py-style preprocessing and output packing, D should match B.
"""
...
print("=" * 80)
print("KuiSau Golden Matrix-Add Test")
print("=" * 80)
