#!/usr/bin/env python3
"""
KuiSau deterministic int16 dequantization golden-reference test.

This config runs GEMM with shift_mode=1 and cutbit=2. SauGoldenGen uses the
same int16 identity A layout as gemm_shift, then checks int16 dequantization
and output byte packing.
"""
...
print("=" * 80)
print("KuiSau Golden Int16 Dequant Test")
print("=" * 80)
