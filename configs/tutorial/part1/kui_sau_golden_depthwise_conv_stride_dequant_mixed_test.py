#!/usr/bin/env python3
"""
KuiSau deterministic depthwise-convolution stride+dequant golden-reference test.

This config runs conv_kernel=2 with register_mode=2, stride=1, work_mode=2,
and cutbit=2. SauGoldenGen checks that the DW B-column mask still composes with
stride row selection and mixed-sign dequantization.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="depthwise_conv_stride_dequant_mixed",
)
...
print("=" * 80)
print("KuiSau Golden Depthwise-Conv Stride+Dequant Test")
print("=" * 80)
