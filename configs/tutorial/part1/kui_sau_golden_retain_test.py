#!/usr/bin/env python3
"""
KuiSau deterministic output-retain golden-reference test.

This config runs two GEMM instructions in one simulation. The first uses
flow_mode=2 to retain D_matrix; the second normal GEMM should accumulate on the
retained matrix and write doubled output bytes.
"""
...
print("=" * 80)
print("KuiSau Golden Retain Test")
print("=" * 80)
