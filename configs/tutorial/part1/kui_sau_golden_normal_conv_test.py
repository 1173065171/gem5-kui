#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution golden-reference test.

This config runs conv_kernel=2 with register_mode=0. SauGoldenGen writes one
nonzero A lane and checks the SAU.py-derived D bytes after normal-conv staging.
"""
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Test")
print("=" * 80)
