#!/usr/bin/env python3
"""
KuiSau deterministic depthwise-convolution rich-data golden-reference test.

This config runs conv_kernel=2 with register_mode=2. SauGoldenGen writes
multiple signed A lanes and distinct signed B kernel rows, then checks the
SAU.py-derived D bytes after the depthwise B-column mask and int8 output
packing.
"""
...
print("=" * 80)
print("KuiSau Golden Depthwise-Conv Rich-Data Test")
print("=" * 80)
