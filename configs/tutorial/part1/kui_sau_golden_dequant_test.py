#!/usr/bin/env python3
"""
KuiSau deterministic dequantization golden-reference test.

This config runs GEMM with cutbit=2. SauGoldenGen uses all-one A rows and a
scaled B pattern so the output checks both right-shift dequantization and int8
saturation.
"""
...
print("=" * 80)
print("KuiSau Golden Dequant Test")
print("=" * 80)
