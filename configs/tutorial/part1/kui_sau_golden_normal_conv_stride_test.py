#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution stride-mode golden-reference test.

This config runs conv_kernel=2 with register_mode=0 and stride=1.
SauGoldenGen writes one nonzero A lane in input row 1 and checks that
SAU.py-style conv staging moves the packed D output to row 8.
"""
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Stride Test")
print("=" * 80)
