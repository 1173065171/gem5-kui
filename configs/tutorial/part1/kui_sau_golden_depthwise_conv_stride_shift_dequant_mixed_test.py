#!/usr/bin/env python3
"""
KuiSau deterministic depthwise-convolution stride+shift+dequant golden test.

This config runs conv_kernel=2 with register_mode=2, stride=1, shift_mode=1,
work_mode=2, and cutbit=2. SauGoldenGen checks the same mixed-mode path under
the DW B-column mask.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="depthwise_conv_stride_shift_dequant_mixed",
)
...
print("=" * 80)
print("KuiSau Golden Depthwise-Conv Stride+Shift+Dequant Test")
print("=" * 80)
