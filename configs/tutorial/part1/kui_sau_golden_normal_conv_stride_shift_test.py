#!/usr/bin/env python3
"""
KuiSau deterministic normal-convolution stride+shift golden-reference test.

This config runs conv_kernel=2 with register_mode=0, stride=1, and
shift_mode=1. SauGoldenGen writes one nonzero A lane in input row 1 and checks
the SAU.py-derived 512-byte int16 D output packing after stride merging.
"""
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Stride+Shift Test")
print("=" * 80)
