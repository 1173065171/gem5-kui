#!/usr/bin/env python3
"""
KuiSau normal-convolution stride test with RTL-style C-read gating.

This config keeps the SAU.py-derived normal_conv_stride output check, but asks
KuiSau to gate C/bias memory reads like RTL mem_addr.sv. Because the vector uses
work_mode=0 and zero C data, the functional D output stays unchanged while the
request trace should report no C reads.
"""
...
print("=" * 80)
print("KuiSau Golden Normal-Conv Stride RTL-Trace Test")
print("=" * 80)
