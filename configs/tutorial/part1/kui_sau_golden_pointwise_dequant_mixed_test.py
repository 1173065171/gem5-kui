#!/usr/bin/env python3
"""
KuiSau deterministic pointwise dequantization golden-reference test.

This config runs pointwise convolution with work_mode=2 and cutbit=2.
SauGoldenGen uses identity A, alternating signed B columns, and all-one C bias
to check signed dequantization after C is shifted into accumulator scale.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="pointwise_dequant_mixed",
)
...
print("=" * 80)
print("KuiSau Golden Pointwise Mixed Dequant Test")
print("=" * 80)
