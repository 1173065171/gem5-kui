#!/usr/bin/env python3
"""
KuiSau deterministic depthwise-convolution shift-mode golden-reference test.

This config runs conv_kernel=2 with register_mode=2 and shift_mode=1.
SauGoldenGen writes one nonzero A lane and checks the SAU.py-derived 512-byte
int16 D output packing after the DW B-column mask.
"""
...
system.golden = SauGoldenGen(
    ...
    poll_interval=20,
    max_busy_polls=1000,
    test_case="depthwise_conv_shift",
)
...
print("=" * 80)
print("KuiSau Golden Depthwise-Conv Shift Test")
print("=" * 80)
