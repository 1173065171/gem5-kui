#!/usr/bin/env python3
"""
KuiSau deterministic golden-reference test.

This config runs a small GEMM vector through KuiSau. SauGoldenGen initializes
memory, writes the logical CSR words, polls busy, reads D memory, and compares
the bytes against an SAU.py-derived expected output.
"""
