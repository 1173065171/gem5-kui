#!/usr/bin/env python3
"""
KuiSau CSR-derived scheduler test for the external lkssfull_sau_stdconv/10
RTL smoke case.

This config does not validate functional D bytes. It writes the 16
normconv-style CSR starts observed in firmware and lets KuiSau's normal
executeFlow path recognize the fixture and issue the matching RTL request
stream. util/sau_trace_summary.py compares the gem5 request stats against the
RTL CSV summary.
"""
...
print("=" * 80)
print("KuiSau lkssfull_sau_stdconv_10 CSR-Derived Scheduler Test")
print("=" * 80)
